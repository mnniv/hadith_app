            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  'نحن لا نعتمد على الذكاء الاصطناعي وحده للحكم على الحديث. الحكم في هذا التطبيق منقول دائمًا من مصدر حديثي، ويُعرض باسم المحدّث والكتاب والصفحة، مع رابط يعود بك إلى المصدر.',
                ),
                SizedBox(height: 20.h),
                ...
                _buildStep(
                  4,
                  'نعرض نص الحديث والراوي والمصدر ورقم الصفحة وحكم المحدّث كما ورد حرفيًا، مع رابط المصدر.',
                ),
                _buildStep(
                  5,
